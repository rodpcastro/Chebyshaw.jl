...
using Chebyshaw: ChebyshevSeries, TransformedChebyshevSeries, ChebyshevCluster, gradient,
    hessian, normalize, contains, reduce, clenshaw, gradient_clenshaw, hessian_clenshaw,
    order, domain
...
# this limitation is the Clenshaw algorithm's implementation.
